...
import { downloadReceiptHandler, emailReceiptHandler, getReceiptAuditTrailHandler, getReceiptsHandler } from '../controllers/receipts.controller';
...
receiptsRoutes.get('/:invoiceId/audit-trail', catchErrors(getReceiptAuditTrailHandler));
