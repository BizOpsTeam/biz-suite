...
export const addExpenseCategoryHandler = catchErrors(
...
export const getExpenseCategoriesHandler = catchErrors(
    async (req: Request, res: Response) => {
        const ownerId = req.user?.id;
        appAssert(ownerId, 401, "Unauthorized");
...
export const getExpenseCategoryHandler = catchErrors(
    async (req: Request, res: Response) => {
        const ownerId = req.user?.id;
        appAssert(ownerId, 401, "Unauthorized");
        const { id } = req.params;
...
export const updateExpenseCategoryHandler = catchErrors(
    async (req: Request, res: Response) => {
        const ownerId = req.user?.id;
        appAssert(ownerId, 401, "Unauthorized");
        const { id } = req.params;
...
export const deleteExpenseCategoryHandler = catchErrors(
    async (req: Request, res: Response) => {
        const ownerId = req.user?.id;
        appAssert(ownerId, 401, "Unauthorized");
        const { id } = req.params;
