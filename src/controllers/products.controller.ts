...
import { createProduct, createProductCategory, getMyProducts, getProductById, getProductCategories, getProductCategoryById, updateCategory } from "../services/products.service";
...
export const updateCategoryHandler = catchErrors(async (req, res) => {
    ...
    res.status(204).json({ data: updateCategory, message: "category updated successfully"})
})