...
export const addStockAdjustmentHandler = catchErrors(async (req: Request, res: Response) => {
    ...
    res.status(CREATED).json({ data: adj, message: "Stock adjustment created" });
});

export const getStockAdjustmentsHandler = catchErrors(async (req: Request, res: Response) => {
    const filters = {
    ...
    res.status(OK).json({ data: adjs, message: "Stock adjustments fetched" });
});

export const getStockAdjustmentHandler = catchErrors(async (req: Request, res: Response) => {
    const { id } = req.params;
    const adj = await getStockAdjustmentById(id);
    res.status(OK).json({ data: adj, message: "Stock adjustment fetched" });
});

export const deleteStockAdjustmentHandler = catchErrors(async (req: Request, res: Response) => {
